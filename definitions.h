...
#define F_CPU 16000000UL // Sätter klockfrekvensen till 16 MHz. här var en nolla för mycket
...
typedef enum IO_port { IO_PORTB, IO_PORTC, IO_PORTD } IO_port; /* Enumeration för I/O-portar. */
